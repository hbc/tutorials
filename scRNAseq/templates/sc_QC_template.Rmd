...
# Copy cycle.rda and seurat_raw.rds to O2 if not already there to perform clustering. I perform clustering on O2 using: https://github.com/hbc/tutorials/blob/master/scRNAseq/scripts/clustering_pre_regress.R, followed by https://github.com/hbc/tutorials/blob/master/scRNAseq/scripts/clustering_regress.R.
```
